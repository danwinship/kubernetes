	...
	testCases := []struct {
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				{
					...
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("10.20.30.51/24")},
				},
				{
					itf:   net.Interface{Index: 2, MTU: 0, Name: "eth1", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("100.200.201.1/24")},
				},
			},
			expected: map[v1.IPFamily]expectation{
				v1.IPv4Protocol: {
		...
		},
		{
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				...
				},
				{
					...
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("127.0.0.1/8")},
				},
			},
			expected: map[v1.IPFamily]expectation{
				v1.IPv4Protocol: {
		...
		},
		{
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				{
					itf:   net.Interface{Index: 0, MTU: 0, Name: "eth0", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("2001:db8::1/64")},
				},
				{
					itf:   net.Interface{Index: 1, MTU: 0, Name: "lo", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("::1/128")},
				},
			},
			expected: map[v1.IPFamily]expectation{
				v1.IPv4Protocol: {
		...
		},
		{
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				{
					itf:   net.Interface{Index: 1, MTU: 0, Name: "lo", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("127.0.1.1/8")},
				},
			},
			expected: map[v1.IPFamily]expectation{
				v1.IPv4Protocol: {
		...
		},
		{
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				{
					itf:   net.Interface{Index: 0, MTU: 0, Name: "eth0", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("192.168.1.2/24")},
				},
				{
					itf:   net.Interface{Index: 1, MTU: 0, Name: "lo", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("127.0.0.1/8")},
		...
		},
		{
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				{
					itf:   net.Interface{Index: 0, MTU: 0, Name: "eth0", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{netutils.MustParseIPAsIPNet("1.2.3.4/30")},
				},
			},
			expected: map[v1.IPFamily]expectation{
				v1.IPv4Protocol: {
			...
			itfAddrsPairs: []InterfaceAddrsPair{
				{
					itf: net.Interface{Index: 0, MTU: 0, Name: "eth0", HardwareAddr: nil, Flags: 0},
					addrs: []net.Addr{
						netutils.MustParseIPAsIPNet("1.2.3.4/30"),
						netutils.MustParseIPAsIPNet("2001:db8::1/64"),
					},
				},
				{
					itf: net.Interface{Index: 1, MTU: 0, Name: "lo", HardwareAddr: nil, Flags: 0},
