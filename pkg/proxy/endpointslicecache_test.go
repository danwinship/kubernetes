	...
	testCases := map[string]struct {
		...
		"2 slices, same port": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					&BaseEndpointInfo{Endpoint: "10.0.1.1:80", IP: "10.0.1.1", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", IP: "10.0.1.2", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.3:80", IP: "10.0.1.3", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.2.1:80", IP: "10.0.2.1", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.2.2:80", IP: "10.0.2.2", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.2.3:80", IP: "10.0.2.3", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
				},
			},
		},
		...
		"2 overlapping slices, same port": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					...
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", IP: "10.0.1.2", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.3:80", IP: "10.0.1.3", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.4:80", IP: "10.0.1.4", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
				},
			},
		},
		...
		"2 slices, overlapping endpoints, some endpoints unready in 1 or both": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					&BaseEndpointInfo{Endpoint: "10.0.1.10:80", IP: "10.0.1.10", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.1:80", IP: "10.0.1.1", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", IP: "10.0.1.2", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.3:80", IP: "10.0.1.3", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.4:80", IP: "10.0.1.4", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.5:80", IP: "10.0.1.5", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.6:80", IP: "10.0.1.6", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.7:80", IP: "10.0.1.7", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.8:80", IP: "10.0.1.8", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.9:80", IP: "10.0.1.9", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
				},
			},
		},
		...
		"2 slices, overlapping endpoints, some endpoints unready and some endpoints terminating": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					&BaseEndpointInfo{Endpoint: "10.0.1.10:80", IP: "10.0.1.10", Port: 80, IsLocal: false, Ready: false, Serving: true, Terminating: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.1:80", IP: "10.0.1.1", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", IP: "10.0.1.2", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.3:80", IP: "10.0.1.3", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.4:80", IP: "10.0.1.4", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.5:80", IP: "10.0.1.5", Port: 80, IsLocal: false, Ready: false, Serving: true, Terminating: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.6:80", IP: "10.0.1.6", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.7:80", IP: "10.0.1.7", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.8:80", IP: "10.0.1.8", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.9:80", IP: "10.0.1.9", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
		...
		"2 slices, overlapping endpoints, all unready": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					&BaseEndpointInfo{Endpoint: "10.0.1.10:80", IP: "10.0.1.10", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.1:80", IP: "10.0.1.1", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", IP: "10.0.1.2", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.3:80", IP: "10.0.1.3", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.4:80", IP: "10.0.1.4", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.5:80", IP: "10.0.1.5", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.6:80", IP: "10.0.1.6", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.7:80", IP: "10.0.1.7", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.8:80", IP: "10.0.1.8", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.9:80", IP: "10.0.1.9", Port: 80, IsLocal: false, Ready: false, Serving: false, Terminating: false},
				},
			},
		},
		...
		"Different endpoints with duplicate IPs should not be filtered": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					&BaseEndpointInfo{Endpoint: "10.0.1.1:80", IP: "10.0.1.1", Port: 80, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.1:8080", IP: "10.0.1.1", Port: 8080, IsLocal: false, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", IP: "10.0.1.2", Port: 80, IsLocal: true, Ready: true, Serving: true, Terminating: false},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:8080", IP: "10.0.1.2", Port: 8080, IsLocal: true, Ready: true, Serving: true, Terminating: false},
				},
			},
		},
	}
