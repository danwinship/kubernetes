...
func TestDeleteEndpointConnectionsIPv4(t *testing.T) {
	...
	testCases := []struct {
		...
		slice        *discovery.EndpointSlice // Will be generated by test
	...
	for i := range testCases {
		...
		tc.slice = makeTestEndpointSlice("ns1", tc.svcName, 1, func(eps *discovery.EndpointSlice) {
		...
		populateEndpointSlices(fp, tc.slice)
	}
	fp.syncProxyRules()
	...
	for _, tc := range testCases {
		...
		fp.OnEndpointSliceDelete(tc.slice)
		fp.syncProxyRules()
