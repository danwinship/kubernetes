...
func (kl *Kubelet) defaultNodeStatusFuncs() []func(*v1.Node) error {
	...
	setters = append(setters,
		nodestatus.NodeAddress(kl.nodeIPs, kl.legacyNodeIP, kl.nodeIPValidator, kl.hostname, kl.hostnameOverridden, kl.externalCloudProvider, kl.cloud, nodeAddressesFunc),
