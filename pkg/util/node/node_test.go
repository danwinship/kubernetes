...
func TestGetNodeHostIPs(t *testing.T) {
	testcases := []struct {
		...
		},
		{
			...
			expectIPs: netutils.MustParseIPList("1.2.3.4"),
		},
		{
		...
		},
		{
			...
			expectIPs: netutils.MustParseIPList("4.3.2.1"),
		},
		{
			...
			expectIPs: netutils.MustParseIPList("1.2.3.4", "a:b::c:d"),
		},
		{
		...
		},
		{
			...
			expectIPs: netutils.MustParseIPList("a:b::c:d", "4.3.2.1"),
		},
	}
