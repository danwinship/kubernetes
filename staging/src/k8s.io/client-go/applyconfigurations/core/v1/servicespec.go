...
type ServiceSpecApplyConfiguration struct {
	...
	IPFamilies                    []metav1.IPFamily                        `json:"ipFamilies,omitempty"`
...
func (b *ServiceSpecApplyConfiguration) WithIPFamilies(values ...metav1.IPFamily) *ServiceSpecApplyConfiguration {
	for i := range values {
