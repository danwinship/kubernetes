...
var (
	ipv4Route = Route{Interface: "eth3", Destination: netutils.MustParseIP("0.0.0.0"), Gateway: netutils.MustParseIP("10.254.0.1"), Family: familyIPv4}
	ipv6Route = Route{Interface: "eth3", Destination: netutils.MustParseIP("::"), Gateway: netutils.MustParseIP("2001:1::1"), Family: familyIPv6}
)
...
func TestFinalIP(t *testing.T) {
	testCases := []struct {
		...
		{"ip4", []net.Addr{addrStruct{val: "10.254.12.132/17"}}, familyIPv4, netutils.MustParseIP("10.254.12.132")},
		{"ip6", []net.Addr{addrStruct{val: "2001::5/64"}}, familyIPv6, netutils.MustParseIP("2001::5")},
...
func TestGetIPFromInterface(t *testing.T) {
	testCases := []struct {
		...
		{"ipv4", "eth3", familyIPv4, validNetworkInterface{}, netutils.MustParseIP("10.254.71.145"), ""},
		{"ipv6", "eth3", familyIPv6, ipv6NetworkInterface{}, netutils.MustParseIP("2001::200"), ""},
...
func TestGetIPFromLoopbackInterface(t *testing.T) {
	testCases := []struct {
		...
		{"ipv4", familyIPv4, linkLocalLoopbackNetworkInterface{}, netutils.MustParseIP("10.1.1.1"), ""},
		{"ipv6", familyIPv6, linkLocalLoopbackNetworkInterface{}, netutils.MustParseIP("fd00:1:1::1"), ""},
...
func TestChooseHostInterfaceFromRoute(t *testing.T) {
	testCases := []struct {
		...
		{"single-stack ipv4", routeV4, validNetworkInterface{}, preferIPv4, netutils.MustParseIP("10.254.71.145")},
		{"single-stack ipv4, prefer v6", routeV4, validNetworkInterface{}, preferIPv6, netutils.MustParseIP("10.254.71.145")},
		{"single-stack ipv6", routeV6, ipv6NetworkInterface{}, preferIPv4, netutils.MustParseIP("2001::200")},
		{"single-stack ipv6, prefer v6", routeV6, ipv6NetworkInterface{}, preferIPv6, netutils.MustParseIP("2001::200")},
		{"dual stack", bothRoutes, v4v6NetworkInterface{}, preferIPv4, netutils.MustParseIP("10.254.71.145")},
		{"dual stack, prefer v6", bothRoutes, v4v6NetworkInterface{}, preferIPv6, netutils.MustParseIP("2001::10")},
		{"LLA and loopback with global, IPv4", routeV4, linkLocalLoopbackNetworkInterface{}, preferIPv4, netutils.MustParseIP("10.1.1.1")},
		{"LLA and loopback with global, IPv6", routeV6, linkLocalLoopbackNetworkInterface{}, preferIPv6, netutils.MustParseIP("fd00:1:1::1")},
		{"LLA and loopback with global, dual stack prefer IPv4", bothRoutes, linkLocalLoopbackNetworkInterface{}, preferIPv4, netutils.MustParseIP("10.1.1.1")},
		{"LLA and loopback with global, dual stack prefer IPv6", bothRoutes, linkLocalLoopbackNetworkInterface{}, preferIPv6, netutils.MustParseIP("fd00:1:1::1")},
		{"LLA and loopback with global, no routes", noRoutes, linkLocalLoopbackNetworkInterface{}, preferIPv6, nil},
		{"interface and loopback with global, IPv4", routeV4, globalsNetworkInterface{}, preferIPv4, netutils.MustParseIP("192.168.1.1")},
		{"interface and loopback with global, IPv6", routeV6, globalsNetworkInterface{}, preferIPv6, netutils.MustParseIP("fd00::200")},
		{"interface and loopback with global, dual stack prefer IPv4", bothRoutes, globalsNetworkInterface{}, preferIPv4, netutils.MustParseIP("192.168.1.1")},
		{"interface and loopback with global, dual stack prefer IPv6", bothRoutes, globalsNetworkInterface{}, preferIPv6, netutils.MustParseIP("fd00::200")},
...
func TestMemberOf(t *testing.T) {
	testCases := []struct {
		...
		{"ipv4 is 4", netutils.MustParseIP("10.20.30.40"), familyIPv4, true},
		{"ipv4 is 6", netutils.MustParseIP("10.10.10.10"), familyIPv6, false},
		{"ipv6 is 4", netutils.MustParseIP("2001::100"), familyIPv4, false},
		{"ipv6 is 6", netutils.MustParseIP("2001::100"), familyIPv6, true},
	}
	for _, tc := range testCases {
...
func TestGetIPFromHostInterfaces(t *testing.T) {
	testCases := []struct {
		...
		{"single-stack ipv4", validNetworkInterface{}, preferIPv4, netutils.MustParseIP("10.254.71.145"), ""},
		{"single-stack ipv4, prefer ipv6", validNetworkInterface{}, preferIPv6, netutils.MustParseIP("10.254.71.145"), ""},
		{"single-stack ipv6", ipv6NetworkInterface{}, preferIPv4, netutils.MustParseIP("2001::200"), ""},
		{"single-stack ipv6, prefer ipv6", ipv6NetworkInterface{}, preferIPv6, netutils.MustParseIP("2001::200"), ""},
		{"dual stack", v4v6NetworkInterface{}, preferIPv4, netutils.MustParseIP("10.254.71.145"), ""},
		{"dual stack, prefer ipv6", v4v6NetworkInterface{}, preferIPv6, netutils.MustParseIP("2001::10"), ""},
	}
