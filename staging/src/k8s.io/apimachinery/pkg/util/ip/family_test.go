...
func TestIPFamilyOf(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			if isIPv4 != (tc.family == metav1.IPv4Protocol) {
				t.Errorf("Expect ipv4 %v, net.IP got %v", tc.family == metav1.IPv4Protocol, isIPv6)
			}
			if isIPv6 != (tc.family == metav1.IPv6Protocol) {
				t.Errorf("Expect ipv6 %v, net.IP got %v", tc.family == metav1.IPv6Protocol, isIPv6)
			}
			...
			if isIPv4 != (tc.family == metav1.IPv4Protocol) {
				t.Errorf("Expect ipv4 %v, netip.Addr got %v", tc.family == metav1.IPv4Protocol, isIPv6)
			}
			if isIPv6 != (tc.family == metav1.IPv6Protocol) {
				t.Errorf("Expect ipv6 %v, netip.Addr got %v", tc.family == metav1.IPv6Protocol, isIPv6)
			}
			...
			if tc.str != "" {
				...
				if isIPv4 != (tc.family == metav1.IPv4Protocol) {
					t.Errorf("Expect ipv4 %v, str got %v", tc.family == metav1.IPv4Protocol, isIPv6)
				}
				if isIPv6 != (tc.family == metav1.IPv6Protocol) {
					t.Errorf("Expect ipv6 %v, str got %v", tc.family == metav1.IPv6Protocol, isIPv6)
				}
...
func TestIPFamilyOfString(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			if isIPv4 != (tc.family == metav1.IPv4Protocol) {
				t.Errorf("Expect %q ipv4 %v, got %v", tc.str, tc.family == metav1.IPv4Protocol, isIPv6)
			}
			if isIPv6 != (tc.family == metav1.IPv6Protocol) {
				t.Errorf("Expect %q ipv6 %v, got %v", tc.str, tc.family == metav1.IPv6Protocol, isIPv6)
			}
		})
	}
}
...
// invalid string values are below in TestIPFamilyOfMore().
func TestIPFamilyOfCIDR(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			if isIPv4 != (tc.family == metav1.IPv4Protocol) {
				t.Errorf("Expect ipv4 %v, *net.IPNet got %v", tc.family == metav1.IPv4Protocol, isIPv6)
			}
			if isIPv6 != (tc.family == metav1.IPv6Protocol) {
				t.Errorf("Expect ipv6 %v, *net.IPNet got %v", tc.family == metav1.IPv6Protocol, isIPv6)
			}
			...
			if isIPv4 != (tc.family == metav1.IPv4Protocol) {
				t.Errorf("Expect ipv4 %v, netip.Prefix got %v", tc.family == metav1.IPv4Protocol, isIPv6)
			}
			if isIPv6 != (tc.family == metav1.IPv6Protocol) {
				t.Errorf("Expect ipv6 %v, netip.Prefix got %v", tc.family == metav1.IPv6Protocol, isIPv6)
			}
	...
	for _, tc := range testCases {
		t.Run(tc.desc, func(t *testing.T) {
			...
			for i := range tc.cidrs {
				_, ipnets[i], _ = net.ParseCIDR(tc.cidrs[i])
